            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Business Listings</li>
                    </ol>
                </nav>
            </div>
            <a href="{{ route('business.show.form') }}" class="btn btn-primary">
        ...
        initComplete: function() {
            ...
            let listingTypeDropdown = `
                <select id="listingTypeFilter" class="form-select form-select-sm"
                    ...
                    {{-- First 2 options --}}
                    @foreach ($listing_types->take(2) as $type)
                    ...
                    @if($listing_types->count() > 2)
                        ...
                        <option value="{{ $last->id }}">{{ $last->listing_type }}</option>
                    @endif
                </select>
            `;
