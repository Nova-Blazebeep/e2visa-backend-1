        ...
        <div class="bg-white">
            <form class="p-3 form" id="businessForm" enctype="multipart/form-data">
                ...
                <fieldset class="row mb-3 mt-3">
                    ...
                    <div class="col-sm-9">
                        <div class="col-md-9">
                            ...
                            <div id="nda_upload_section" class="ms-4 mt-2"
                ...
                <fieldset class="row mb-3 mt-3">
                    ...
                    <div class="col-sm-9">
                        <div class="form-check">
                            <div class="col-md-9 d-flex inner-type">
                                <div class="input-group mb-3">
                ...
                {{-- Show existing gallery images so user knows they are saved --}}
                ...
                <fieldset class="row mb-3 mt-3">
                    ...
                    <div class="col-sm-9">
                        <div class="form-check">
                            <div class="col-md-5 d-flex">
                                <input type="file"
                                    class="form-control" id="seller_financial_documents"
