    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header d-flex flex-wrap justify-content-between align-items-center">
                ...
                <button class="btn btn-success btn-sm" id="addCategoryButton" data-title="Add Category"
                    data-url="{{ route('portal.categories.create') }}">
                    Add Category
                </button>
            </div>
    ...
    <script>
        $(function() {
            let categoryTable = $('#categoryTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('portal.categories.list') }}",
                responsive: true,
                stateSave: true,
                columns: [{
                        data: 'id'
            ...
            function openCategoryModal(url, title) {
                ...
                $.get(url, function(html) {
                    ...
                    let actionUrl = url.includes('/edit') ?
                        ...
                        "{{ route('portal.categories.storeOrUpdate') }}";
